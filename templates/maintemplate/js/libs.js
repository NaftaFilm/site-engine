...
$(document).ready(function(){
	...
	/*! Здесь вы можете изменить какие либо настройки */
	...
	$("#owl-carou").owlCarousel({    
			...
			paginationSpeed : 400,
			singleItem:false,
			itemsCustom: [[0, 2], [470, 3], [590, 3], [760, 4], [950, 5], [1220, 7]],
			autoPlay:false,
			pagination: false
	});
	$("#owl-caroubottom").owlCarousel({    
			navigation : true,
			navigationText: [
			...
			paginationSpeed : 400,
			singleItem:false,
			itemsCustom: [[0, 1], [470, 2], [590, 2], [760, 3], [950, 4], [1220, 5]],
			autoPlay:false,
			pagination: false
	});
	$("#owl-carouside").owlCarousel({    
		navigation : true,
		navigationText: [
			  "<span class='fa fa-angle-left'></span>",
			  "<span class='fa fa-angle-right'></span>"
	...
	$("#owl-rels").owlCarousel({    
		...
		paginationSpeed : 400,
		singleItem:false,
		itemsCustom: [[0, 2], [470, 3], [590, 3], [760, 4], [950, 6], [1220, 5]],
		autoPlay:false,
		pagination: false
	});
	$('.movie-desc.full-text').wTextSlicer({
	    height: '200',
	    text: 'Развернуть'
	});
