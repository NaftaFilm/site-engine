...
#fullsearch .options {position: relative;border: solid 1px #000;}
#fullsearch .options:last-of-type {margin: 0 0 10px 0;}
#fullsearch .options > div {position: relative;border-top: solid 1px #000;background: #161c20;max-height: 50px;overflow: hidden;
...
#fullsearch .options > div:not(.switch) .title:hover {background: #161c20;}
#fullsearch .options > div:not(.switch) .title:after {content: '';position: absolute;bottom: 0;right: 0;left: 0;height: 1px;background: #000;}
